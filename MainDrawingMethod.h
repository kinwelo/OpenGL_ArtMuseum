...
class MainDrawingMethod :
	public Object3D
{
public:
	MainDrawingMethod(std::string plik) : Object3D(plik)
	{
		;
	}
	...
	)
	{
		...
		glUniform4fv(sp->u("lp[0]"), 1, glm::value_ptr(lightSource));
		glUniform4fv(sp->u("lp[1]"), 1, glm::value_ptr(lightSource2));
